...
function listarUsuario($filtroNome)
{
    ...
    foreach ($usuarios as $usuario) {
        ...
        echo "<td><a href='http://localhost/php/padaria/telas/usuario/cadastro_usuario?id=" . $usuario->id . "'>Alterar</a>";
        echo " | ";
        echo "<a href='http://localhost/php/padaria/telas/usuario/executa_aca0_usuario.php?acao=remover&id=" . $usuario->id . "'>Remover</a></td>";
        echo "</tr>";
    }
    echo "</tbody></table>";
