...
{
    return Funcionario::pegaPorId($id, __DIR__ . "/../db/funcionario.txt", "Funcionario");
}

function alterarFuncionario($id, $novoNome, $novoSalario, $novoTelefone)
{
    $funcionario = Funcionario::pegaPorId($id, __DIR__ . "/../db/funcionario.txt", "Funcionario");
    if ($funcionario) {
...
function listarFuncionario($filtroNome)
{
    ...
    foreach ($funcionarios as $funcionario) {
        ...
        echo "<td><a href='http://localhost/php/padaria/telas/funcionario/cadastro_funcionario?id=" . $funcionario->id . "'>Alterar</a>";
        echo " | ";
        echo "<a href='http://localhost/php/padaria/telas/funcionario/executa_acao_funcionario.php?acao=remover&id=" . $funcionario->id . "'>Remover</a></td>";
        echo "</tr>";
    }
    echo "</tbody></table>";
