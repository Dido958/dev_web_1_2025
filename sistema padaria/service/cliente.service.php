...
function listarCliente($filtroNome)
{
    ...
    foreach ($clientes as $cliente) {
        ...
        echo "<td><a href='http://localhost/php/padaria/telas/cliente/cadastro_cliente.php?id=" . $cliente->id . "'>Alterar</a>";
        echo " | ";
        echo "<a href='http://localhost/php/padaria/telas/cliente/executa_acao_cliente.php?acao=remover&id=" . $cliente->id . "'>Remover</a></td>";
        echo "</tr>";
    }
    echo "</tbody></table>";
