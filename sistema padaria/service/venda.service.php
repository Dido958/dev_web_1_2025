...
function listarVenda($filtroIdProduto = "")
{
    ...
    foreach ($vendas as $venda) {
        ...
        echo "<td>
                <a href='http://localhost/php/padaria/telas/venda/cadastro_venda.php{$venda->id}'>Alterar</a> |
                <a href='http://localhost/php/padaria/telas/venda/executa_acao_venda.php?acao=remover&id={$venda->id}'>Remover</a>
              </td>";
        echo "</tr>";
    }
