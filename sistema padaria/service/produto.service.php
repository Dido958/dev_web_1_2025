...
function listarProduto($filtroNome)
{
    ...
    foreach ($produtos as $produto) {
        ...
        echo "<td><a href='http://localhost/php/padaria/telas/produto/cadastro_produto.php?id=" . $produto->id . "'>Alterar</a>";
        echo " | ";
        echo "<a href='http://localhost/php/padaria/telas/produto/executa_acao_produto.php?acao=remover&id=" . $produto->id . "'>Remover</a></td>";
        echo "</tr>";
    }
    echo "</tbody></table>";
